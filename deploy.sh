...
near call $CONTRACT_NAME ft_transfer '{"receiver_id": "'alice.$CONTRACT_NAME'", "amount": "1000"}' --accountId $CONTRACT_NAME --amount 0.000000000000000000000001
...
near call $CONTRACT_NAME ft_transfer '{"receiver_id": "'bob.$CONTRACT_NAME'", "amount": "1000"}' --accountId $CONTRACT_NAME --amount 0.000000000000000000000001
